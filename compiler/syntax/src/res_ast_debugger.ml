...
module SexpAstWithLocs = struct
  ...
  and expression expr =
    ...
    in
    Sexp.list [Sexp.atom "expression"; location expr.pexp_loc; desc]
  ...
  and pattern p =
    ...
    in
    Sexp.list [Sexp.atom "pattern"; location p.ppat_loc; descr]
  ...
  and core_type typexpr =
    let desc =
      ...
      | Ptyp_extension ext ->
        Sexp.list [Sexp.atom "Ptyp_extension"; extension ext]
    in
    Sexp.list [Sexp.atom "core_type"; location typexpr.ptyp_loc; desc]
