...
export function forward_with_closure<A>(
  blk: internal<A>,
  closure: () => A,
): A;

export function raise_undefined<A>(): A;

export function force_lazy_block<A>(blk: internal<A>): A;

export function force_val_lazy_block<A>(blk: internal<A>): A;
...
export function get_<A>(arg0: t<A>): A;
