...
declare namespace Kind {
  type json = t;
  type t$String = "String"; type t$Number = "Number"; type t$Object = "Object"; type t$Array = "Array"; type t$Boolean = "Boolean"; type t$Null = "Null"; type t<_ extends Js_string.t | number | rescript.dict<Kind.json> | Kind.json[] | boolean | Js_types.null_val> = | t$String | t$Number | t$Object | t$Array | t$Boolean | t$Null;
}
export type Kind = {
};
...
export function test<A, A>(x: A, v: Kind.t<A>): boolean;

export function decodeString(json: t): rescript.option<string>;
...
export function decodeNull<A, B>(json: A): rescript.option<rescript.null_<B>>;

export function patch<A, B>(arg0: A): B;
