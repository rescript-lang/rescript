...
export type cell<A> = rescript.option<node<A>>;
...
export function peekUndefined<A>(q: t<A>): rescript.option<A>;
...
export function popUndefined<A>(q: t<A>): rescript.option<A>;

export function copyAux<A>(
  qRes: t<A>,
  prev: cell<A>,
  cell: cell<A>,
): t<A>;
...
export function copyMapAux<A, B>(
  qRes: t<A>,
  prev: cell<A>,
  cell: cell<B>,
  f: (arg0: B) => A,
...
export function iterAux<A>(cell: cell<A>, f: (arg0: A) => void): void;

export function forEach<A>(q: t<A>, f: (arg0: A) => void): void;

export function foldAux<A, B>(
  f: (arg0: A, arg1: B) => A,
  accu: A,
  cell: cell<B>,
): A;
...
export function fillAux<A>(i: number, arr: A.t<A>, cell: cell<A>): void;

export function toArray<A>(x: t<A>): A.t<A>;

export function fromArray<A>(arr: A.t<A>): t<A>;
