...
description: Template skill for agents working in a ReScript codebase with rescript-tools lint and related AI-oriented workflows. Use when creating a project-specific skill for file-by-file editing, lint-repair loops, and semantic checks.
---
...
- fixing lint findings from `rescript-tools lint`
...
```sh
rescript-tools lint <file>
rescript-tools lint <dir-or-root>
rescript-tools lint <file-or-root> --json
```
...
```sh
rescript-tools lint src/File.res
```
