(** Reactive File Collection
    ...
    {[
      ...
      let decls = Reactive.FlatMap.create ~name:"decls" (ReactiveFileCollection.to_collection files)
...
(** Get the reactive collection interface for use with
    [Reactive.FlatMap.create]. *)
