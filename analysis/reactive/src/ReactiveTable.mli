...
val get : 'a t -> int -> 'a ReactiveAllocator.offheap
val set : 'a t -> int -> 'a ReactiveAllocator.offheap -> unit

val push : 'a t -> 'a ReactiveAllocator.offheap -> unit
(** Append an element, growing via the allocator when needed. *)

val pop : 'a t -> 'a ReactiveAllocator.offheap
