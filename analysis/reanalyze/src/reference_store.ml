...
type t =
  ...
  | Reactive of {
      ...
      (* Exception refs_from *)
      exception_value_refs_from: (Lexing.position, Pos_set.t) Reactive.t;
    }
  ...
  Reactive
    {
      value_refs_from;
      type_refs_from;
      all_type_refs_from = type_deps.Reactive_type_deps.all_type_refs_from;
      exception_value_refs_from =
        exception_refs.Reactive_exception_refs.resolved_refs_from;
    }
