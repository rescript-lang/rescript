...
function shadowedDefault(xOpt, outerScope$1) {
  let x = xOpt !== undefined ? xOpt : outerScope;
  return [
    x,
    outerScope$1
  ];
...
function laterUsesEarlier(xOpt, yOpt, param) {
  let x = xOpt !== undefined ? xOpt : 1;
  let y = yOpt !== undefined ? yOpt : x + 1 | 0;
  return x + y | 0;
}
