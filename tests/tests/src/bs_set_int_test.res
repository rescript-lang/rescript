...
module L = Belt.List
module A = Belt.Array
let setEqArray = (s, i) => N.eq(N.fromArray(i), s)
let arrayEqArray = (a, b) => N.eq(N.fromArray(a), N.fromArray(b))
let ofA = N.fromArray
...
describe(__MODULE__, () => {
  test("bs set int test", () => {
    ok(__LOC__, arrayEqArray([1, 2, 3], [3, 2, 1]))
    let u = {
      open N
      intersect(ofA([1, 2, 3]), ofA([3, 4, 5]))
    }
    ok(__LOC__, setEqArray(u, [3]))

    let v = ofA(A.concat(range(100, 1000), revRange(400, 1500)))
    ok(__LOC__, setEqArray(v, range(100, 1500)))
    ...
    ok(__LOC__, N.eq(l, nl))
    ok(__LOC__, N.eq(r, nr))
    ...
    ok(__LOC__, N.subset(aa, bb))
    ok(__LOC__, N.subset(dd, bb))
    ok(__LOC__, N.subset(N.add(dd, 200), bb))
    ok(__LOC__, N.add(dd, 200) === dd)
    ok(__LOC__, N.add(dd, 0) === dd)
    ok(__LOC__, !N.subset(N.add(dd, 201), bb))
    ...
    let ee = N.add(dd, 101)
    ok(__LOC__, N.eq(aa, bb))
    ok(__LOC__, !N.eq(aa, cc))
    ok(__LOC__, !N.eq(dd, cc))
    ok(__LOC__, !N.eq(bb, ee))
    ...
    ok(__LOC__, N.eq(v, v0))
    ok(__LOC__, N.cmp(v, v0) == 0)
    ok(__LOC__, N.cmp(v, v1) < 0)
    ok(__LOC__, N.cmp(v, v2) > 0)
    ok(__LOC__, N.subset(v3, v0))
    ok(__LOC__, !N.subset(v1, v0))
