...
describe(__MODULE__, () => {
  test("bs_poly_map_test_1", () => {
    let u0 = mapOfArray(randomRange(0, 100))
    let u1 = mapOfArray(randomRange(30, 120))
    ok(__LOC__, N.eq(mergeInter(u0, u1), setOfArray(I.range(30, 100))))
    ok(__LOC__, N.eq(mergeUnion(u0, u1), setOfArray(I.range(0, 120))))
    ok(__LOC__, N.eq(mergeDiff(u0, u1), setOfArray(I.range(0, 29))))
    ok(__LOC__, N.eq(mergeDiff(u1, u0), setOfArray(I.range(101, 120))))
  })

  test("bs_poly_map_test_2", () => {
    ...
    ok(__LOC__, M.isEmpty(a8))
  })

  test("bs_poly_map_test_3", () => {
    let u0 = mapOfArray(randomRange(0, 100))
  ...
  test("bs_poly_map_test_5", () => {
    ...
    ok(__LOC__, M.isEmpty(M.remove(emptyMap(), 0)))
    ok(__LOC__, M.isEmpty(M.removeMany(emptyMap(), [0])))
    ok(
      __LOC__,
      switch pres {
      | Some(5_000) => true
    ...
    ok(__LOC__, A.eq(M.keysToArray(v5), A.makeBy(5_000, i => i), (a, b) => a == b))
    ok(__LOC__, A.eq(M.keysToArray(v6), A.makeBy(5_000, i => 5_001 + i), (a, b) => a == b))
    ...
    ok(__LOC__, A.eq(M.keysToArray(v8), A.makeBy(5_000, i => i), (a, b) => a == b))
    ok(__LOC__, A.eq(M.keysToArray(v9), A.makeBy(5_000, i => 5_001 + i), (a, b) => a == b))
  })
})
