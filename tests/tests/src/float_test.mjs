...
Mocha.describe("Float_test", () => {
  Mocha.test("float_test_1", () => {
    Test_utils.eq("File \"float_test.res\", line 22, characters 7-14", isFinite(3), true);
    ...
    Test_utils.eq("File \"float_test.res\", line 43, characters 7-14", Primitive_float.compare(nan, Number.NEGATIVE_INFINITY), -1);
    Test_utils.eq("File \"float_test.res\", line 44, characters 7-14", Primitive_object.compare(nan, Number.NEGATIVE_INFINITY), -1);
    Test_utils.eq("File \"float_test.res\", line 45, characters 7-14", Primitive_float.compare(Number.NEGATIVE_INFINITY, nan), 1);
    Test_utils.eq("File \"float_test.res\", line 46, characters 7-14", Primitive_object.compare(Number.NEGATIVE_INFINITY, nan), 1);
