...
describe(__MODULE__, () => {
  ...
  test("head/tail etc.", () => {
    ...
    throws(__LOC__, () => N.headExn(list{}))
    throws(__LOC__, () => N.tailExn(list{})->ignore)
    throws(__LOC__, () => N.getExn(list{0, 1}, -1)->ignore)
    throws(__LOC__, () => N.getExn(list{0, 1}, 2)->ignore)
    ...
    eq(__LOC__, N.has(list{1, 2, 3}, "2", (x, s) => Int.toString(x) == s), true)
    eq(__LOC__, N.has(list{1, 2, 3}, "0", (x, s) => Int.toString(x) == s), false)
