...
import * as Belt_Range from "@rescript/belt/src/Belt_Range.mjs";
import * as Test_utils from "./test_utils.mjs";
import * as Array_data_util from "./array_data_util.mjs";
import * as Belt_MutableSetInt from "@rescript/belt/src/Belt_MutableSetInt.mjs";
...
Mocha.describe("Bs_mutable_set_test", () => {
  Mocha.test("mutable set basic operations", () => {
    ...
    Test_utils.ok("File \"bs_mutable_set_test.res\", line 16, characters 7-14", Belt_MutableSetInt.removeCheck(u, 0));
    Test_utils.ok("File \"bs_mutable_set_test.res\", line 17, characters 7-14", !Belt_MutableSetInt.removeCheck(u, 0));
    Test_utils.ok("File \"bs_mutable_set_test.res\", line 18, characters 7-14", Belt_MutableSetInt.removeCheck(u, 30));
    ...
    Test_utils.ok("File \"bs_mutable_set_test.res\", line 28, characters 7-14", Belt_MutableSetInt.isEmpty(u));
    Belt_MutableSetInt.add(u, 0);
    Belt_MutableSetInt.add(u, 1);
    Belt_MutableSetInt.add(u, 2);
    Belt_MutableSetInt.add(u, 0);
    Test_utils.eq("File \"bs_mutable_set_test.res\", line 33, characters 7-14", Belt_MutableSetInt.size(u), 3);
    Test_utils.ok("File \"bs_mutable_set_test.res\", line 34, characters 7-14", !Belt_MutableSetInt.isEmpty(u));
    for (let i$1 = 0; i$1 <= 3; ++i$1) {
      Belt_MutableSetInt.remove(u, i$1);
    }
    Test_utils.ok("File \"bs_mutable_set_test.res\", line 38, characters 7-14", Belt_MutableSetInt.isEmpty(u));
    ...
    Test_utils.eq("File \"bs_mutable_set_test.res\", line 41, characters 7-14", Belt_MutableSetInt.size(u), 20001);
    Belt_MutableSetInt.removeMany(u, Array_data_util.randomRange(0, 200));
    Test_utils.eq("File \"bs_mutable_set_test.res\", line 43, characters 7-14", Belt_MutableSetInt.size(u), 19800);
    Belt_MutableSetInt.removeMany(u, Array_data_util.randomRange(0, 1000));
    Test_utils.eq("File \"bs_mutable_set_test.res\", line 45, characters 7-14", Belt_MutableSetInt.size(u), 19000);
    Belt_MutableSetInt.removeMany(u, Array_data_util.randomRange(0, 1000));
    Test_utils.eq("File \"bs_mutable_set_test.res\", line 47, characters 7-14", Belt_MutableSetInt.size(u), 19000);
    Belt_MutableSetInt.removeMany(u, Array_data_util.randomRange(1000, 10000));
    Test_utils.eq("File \"bs_mutable_set_test.res\", line 49, characters 7-14", Belt_MutableSetInt.size(u), 10000);
    Belt_MutableSetInt.removeMany(u, Array_data_util.randomRange(10000, 19999));
    Test_utils.eq("File \"bs_mutable_set_test.res\", line 51, characters 7-14", Belt_MutableSetInt.size(u), 1);
    Test_utils.ok("File \"bs_mutable_set_test.res\", line 52, characters 7-14", Belt_MutableSetInt.has(u, 20000));
    Belt_MutableSetInt.removeMany(u, Array_data_util.randomRange(10000, 30000));
    Test_utils.ok("File \"bs_mutable_set_test.res\", line 54, characters 7-14", Belt_MutableSetInt.isEmpty(u));
  });
  Mocha.test("mutable set add/remove operations", () => {
    ...
    Test_utils.eq("File \"bs_mutable_set_test.res\", line 70, characters 7-14", indeedRemoved, 500);
    Test_utils.eq("File \"bs_mutable_set_test.res\", line 71, characters 7-14", Belt_MutableSetInt.size(v), 501);
    ...
    Test_utils.eq("File \"bs_mutable_set_test.res\", line 83, characters 7-14", indeedAded, 1000);
    Test_utils.eq("File \"bs_mutable_set_test.res\", line 84, characters 7-14", Belt_MutableSetInt.size(v), 1501);
