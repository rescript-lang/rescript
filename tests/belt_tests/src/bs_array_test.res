...
describe(__MODULE__, () => {
  test("bs_array_test_1", () => {
    ...
    throws(__LOC__, _ => ignore(A.getExn([0, 1], -1)))
    throws(__LOC__, _ => ignore(A.getExn([0, 1], 2)))
    ok(
      __LOC__,
      {
        let f = A.getExn([0, 1], ...)
    ...
    throws(__LOC__, _ => A.setExn([0, 1], -1, 0))
    throws(__LOC__, _ => A.setExn([0, 1], 2, 0))
    ok(__LOC__, !A.set([1, 2], 2, 0))
    ok(
      __LOC__,
      {
        let v = [1, 2]
  ...
  let add = (x, y) => x + y
  test("bs_array_test_2", () => {
    let v = A.makeBy(3000, i => i)
    let u = A.shuffle(v)
    ok(__LOC__, u !== v) /* unlikely */
    let sum = x => A.reduce(x, 0, add)
    eq(__LOC__, sum(u), sum(v))
  })

  test("bs_array_test_3", () => {
    open A
    ok(__LOC__, range(0, 3) == [0, 1, 2, 3])
    ok(__LOC__, range(3, 0) == [])
    ok(__LOC__, range(3, 3) == [3])

    ok(__LOC__, rangeBy(0, 10, ~step=3) == [0, 3, 6, 9])
    ok(__LOC__, rangeBy(0, 12, ~step=3) == [0, 3, 6, 9, 12])
    ok(__LOC__, rangeBy(33, 0, ~step=1) == [])
    ok(__LOC__, rangeBy(33, 0, ~step=-1) == [])
    ok(__LOC__, rangeBy(3, 12, ~step=-1) == [])
    ok(__LOC__, rangeBy(3, 3, ~step=0) == [])
    ok(__LOC__, rangeBy(3, 3, ~step=1) == [3])
  })

  test("bs_array_test_4", () => {
    eq(__LOC__, A.reduceReverse([], 100, (a, b) => a - b), 100)
    eq(__LOC__, A.reduceReverse([1, 2], 100, (a, b) => a - b), 97)
    eq(__LOC__, A.reduceReverse([1, 2, 3, 4], 100, (a, b) => a - b), 90)
    eq(__LOC__, A.reduceWithIndex([1, 2, 3, 4], 0, (acc, x, i) => acc + x + i), 16)
    ok(__LOC__, A.reduceReverse2([1, 2, 3], [1, 2], 0, (acc, x, y) => acc + x + y) == 6)
  })
  let addone = x => x + 1
  ...
  test("bs_array_test_make_functions", () => {
    ...
    eq(__LOC__, A.map([1, 2, 3], x => x + 1), [2, 3, 4])
  ...
  test("bs_array_test_keep_functions", () => {
  ...
  test("bs_array_test_slice_functions", () => {
    let a = [1, 2, 3, 4, 5]
  ...
  test("bs_array_test_sliceToEnd_functions", () => {
    let a = [1, 2, 3, 4, 5]
  ...
  test("bs_array_test_fill_functions", () => {
  ...
  test("bs_array_test_blit_functions", () => {
  ...
  test("bs_array_test_zip_functions", () => {
  ...
  test("bs_array_test_iteration_functions", () => {
    eq(__LOC__, sumUsingForEach([0, 1, 2, 3, 4]), 10)
    ok(__LOC__, !A.every([0, 1, 2, 3, 4], x => x > 2))
    ok(__LOC__, A.some([1, 3, 7, 8], x => mod(x, 2) == 0))
    ok(__LOC__, !A.some([1, 3, 7], x => mod(x, 2) == 0))
    ok(__LOC__, !A.eq([0, 1], [1], \"=="))
    ok(
      __LOC__,
      {
        let c = ref(0)
  ...
  test("bs_array_test_id_functions", () => {
    id(__LOC__, [])
    id(__LOC__, [1])
    id(__LOC__, [1, 2])
    id(__LOC__, [1, 2, 3])
  ...
  test("bs_array_test_every2_some2", () => {
    module N = {
  ...
  test("bs_array_test_concat_functions", () => {
  ...
  test("bs_array_test_cmp_functions", () => {
    ok(__LOC__, A.cmp([1, 2, 3], [0, 1, 2, 3], compare) < 0)
    ok(__LOC__, A.cmp([0, 1, 2, 3], [1, 2, 3], compare) > 0)
    ok(__LOC__, A.cmp([1, 2, 3], [0, 1, 2], (x, y) => compare(x, y)) > 0)
    ok(__LOC__, A.cmp([1, 2, 3], [1, 2, 3], (x, y) => compare(x, y)) == 0)
    ok(__LOC__, A.cmp([1, 2, 4], [1, 2, 3], (x, y) => compare(x, y)) > 0)
  })

  test("bs_array_test_getBy_functions", () => {
    eq(__LOC__, A.getBy([1, 2, 3], x => x > 1), Some(2))
    eq(__LOC__, A.getBy([1, 2, 3], x => x > 3), None)
  })

  test("bs_array_test_getIndexBy_functions", () => {
    eq(__LOC__, A.getIndexBy([1, 2, 3], x => x > 1), Some(1))
    eq(__LOC__, A.getIndexBy([1, 2, 3], x => x > 3), None)
  })

  test("bs_array_test_push_functions", () => {
    let arr = []
    arr->push(3)
    arr->push(2)
    arr->push(1)
