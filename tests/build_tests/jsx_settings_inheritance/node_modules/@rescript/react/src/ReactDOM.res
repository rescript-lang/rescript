...
type domProps = Jsx.DOM.domProps

@deprecated("Please use type ReactDOM.domProps")
type props = Jsx.DOM.domProps
...
external jsx: (string, Jsx.DOM.domProps) => Jsx.element = "jsx"

@module("react/jsx-runtime")
external jsxKeyed: (string, Jsx.DOM.domProps, ~key: string=?, @ignore unit) => Jsx.element = "jsx"

@module("react/jsx-runtime")
external jsxs: (string, Jsx.DOM.domProps) => Jsx.element = "jsxs"

@module("react/jsx-runtime")
external jsxsKeyed: (string, Jsx.DOM.domProps, ~key: string=?, @ignore unit) => Jsx.element = "jsxs"
