...
let jsxPlain = <Comp value=/abc/ />
let jsxValue = <Comp value=(/>/) />
let jsxValueSpace = <Comp value=(/ >/) />
let jsxValueTab = <Comp value=(/	>/) />
let jsxValueUnicode = <Comp value=(/é>/u) />
let jsxValueDollar = <Comp value=(/$>/) />
