...
let printFullUser = (steve: {...user, "age": int}) => Console.log(steve)
let printFullUser = (~user: {...user, "age": int}) => Console.log(steve)
let printFullUser = (~user: {...user, "age": int}) => Console.log(steve)
let printFullUser = (~user = steve : {...user, "age": int}) => Console.log(steve)
